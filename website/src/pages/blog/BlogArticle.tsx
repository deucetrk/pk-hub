      ...
      <main>
        ...
        <Container className="py-12 sm:py-16 lg:py-20">
          <article className="mx-auto grid w-full min-w-0 max-w-[48rem] grid-cols-[minmax(0,1fr)] gap-12 text-[1.0625rem] leading-8 text-[#52525b] sm:gap-16 sm:text-lg sm:leading-9">
            ...
            {article.disclaimer ? (
              <aside className="border-l-4 border-[#2457d6] bg-[#ededf0] px-5 py-5 text-base leading-7 text-[#52525b]">
                {article.disclaimer}
              </aside>
            ) : null}

            {article.pullQuote ? (
              <blockquote className="border-l-4 border-[#2457d6] bg-[#ededf0] px-6 py-6 font-display text-xl font-bold leading-8 text-[#27272a] sm:text-2xl sm:leading-9">
                {article.pullQuote}
              </blockquote>
            ) : null}
                ...
                return (
                  <section id={sectionAnchor(index)} key={section.heading} className="min-w-0 scroll-mt-28 border-t border-[#d4d4d8] pt-10 sm:pt-12">
                    <div className="mb-6 grid grid-cols-[2.75rem_1fr] items-start gap-4 sm:grid-cols-[3.25rem_1fr] sm:gap-5">
                      ...
                      <h2 className="font-display text-[1.8rem] font-extrabold leading-[1.25] tracking-[-0.035em] text-[#18181b] sm:text-[2.45rem]">
                        {sectionTitle(section.heading)}
                      </h2>
                    </div>
                      ...
                      {section.visual ? (
                        <figure className="my-3">
                          <img
                            ...
                            loading="lazy"
                            decoding="async"
                            className="aspect-video w-full border border-[#d4d4d8] object-cover"
                          />
                          <figcaption className="border-x border-b border-[#d4d4d8] px-4 py-3 text-sm leading-6 text-[#71717a]">
                            {section.visual.caption}
                          </figcaption>
                        </figure>
                      ) : null}
                      {section.pricingExamples ? (
                        <div className="my-3 border-y border-[#d4d4d8] py-7 sm:py-8">
                          <div className="grid gap-2">
                          ...
                          <p className="mt-7 border-l-2 border-[#2457d6] pl-4 text-sm leading-6 text-[#52525b]">
