        ...
        <section className="border-b border-zinc-300">
          <Container className="grid gap-10 py-12 sm:py-16 lg:grid-cols-[0.82fr_1.18fr] lg:gap-16 lg:py-20">
            <div className="self-start lg:sticky lg:top-28">
              ...
              <ol className="mt-9 grid gap-0 border-y border-zinc-300">
                {steps.map((step, index) => (
                  <li key={step} className="flex gap-4 border-b border-zinc-300 py-5 last:border-b-0">
                    <span className="flex h-7 w-7 shrink-0 items-center justify-center border border-[#8eaaf2] text-sm font-bold text-[#2457d6]">
                      {index + 1}
                    </span>
                    <span className="pt-0.5 text-sm font-semibold leading-6 text-zinc-800">{step}</span>
                  </li>
                ))}
              </ol>
