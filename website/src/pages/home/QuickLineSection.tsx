        ...
        <div className="flex flex-col gap-6 rounded-2xl border border-emerald-200 bg-emerald-50 px-6 py-6 sm:flex-row sm:items-center sm:justify-between sm:px-8">
          <div>
            <div className="text-sm font-semibold text-emerald-700">
              {isThai ? 'หรือคุยกับเราตอนนี้' : 'Prefer to talk now?'}
            </div>
            <div className="font-display mt-1 text-2xl font-bold leading-tight text-zinc-950 sm:text-3xl">
              {isThai ? 'ไม่อยากกรอกฟอร์ม? แชท LINE เลย' : 'Skip the form and chat with us on LINE'}
            </div>
            <div className="mt-2 text-sm leading-6 text-zinc-600">
              {isThai
                ? 'ทีมงานตอบกลับในเวลาทำการ พร้อมส่งรูป โปรโมชัน และเช็กสต็อกให้'
                : 'Our team can share photos, promotions, and live stock during business hours.'}
            </div>
          </div>
          <a
